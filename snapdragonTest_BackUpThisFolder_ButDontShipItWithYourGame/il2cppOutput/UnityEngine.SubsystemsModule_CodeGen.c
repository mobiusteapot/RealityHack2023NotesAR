...
// 0x0000006B TProvider UnityEngine.SubsystemsImplementation.Extensions.SubsystemExtensions::GetProvider(UnityEngine.SubsystemsImplementation.SubsystemWithProvider`3<TSubsystem,TDescriptor,TProvider>)
